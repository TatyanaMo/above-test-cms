...
public class MobileUserProfilePage {
    ...
    private final By CHOICES_LIST_CLOSE_BUTTON = By.xpath(".//button[contains(@class,'md:hidden text-black w-16 h-12 border-l rounded-r-md')]");
    ...
    private final By INFO_BLOCK_TEXT = By.xpath(".//div[@class='sticky top-8 bg-white border rounded p-6 leading-5 space-y-4 break-words']/p");
    private final By INFO_BLOCK_SUB_TITTLES = By.xpath(".//p[@class='font-semibold']");
    private final By INFO_BLOCK_CONTACT_LINKS = By.xpath(".//a[@class='text-orange-400 hover:underline hover:text-orange-500']");
    private final By INFO_BLOCK_GENERAL_LINE_SECTION = By.xpath(".//ul[@class='pt-3 pl-3 space-y-1 break-all']");
    private final By INFO_BLOCK_IMAGES = By.xpath(".//*[name()='svg' and contains(@class, 'w-4 h-4 text-orange-400')]");
    private final By INFO_BLOCK_AGENT_SECTION = By.xpath(".//ul[@class='pt-3 pl-3 space-y-1']");
