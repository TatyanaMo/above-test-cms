...
import static pageobject.pagesForAbove.LocatorsMobile.MobileTermsOfUsePageLocators.*;

public class MobileTermsOfUsePage {

    private final Logger LOGGER = LogManager.getLogger(this.getClass());

    private BaseFunc baseFunc;

    public MobileTermsOfUsePage(BaseFunc baseFunc) {
