...
import static pageobject.pagesForAbove.LocatorsMobile.MobilePrivacyPolicyPageLocators.*;

public class MobilePrivacyPolicyPage {

    private final Logger LOGGER = LogManager.getLogger(this.getClass());

    private BaseFunc baseFunc;

    public MobilePrivacyPolicyPage(BaseFunc baseFunc) {
