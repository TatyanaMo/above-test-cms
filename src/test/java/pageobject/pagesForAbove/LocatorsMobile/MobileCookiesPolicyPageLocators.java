...
public class MobileCookiesPolicyPageLocators {
    ...
    public static final By CLOSE_BUTTONS = By.xpath(".//span[contains(@class,'absolute right-4 top-4 lg:right-0 lg:top-0')]/button");
    ...
    public static final By TEXT = By.xpath(".//div[@data-custom-class='body']");
